            ...
            @foreach ($clients as $client)
                <tr>
                    ...
                    <td class="d-flex">
                        ...
                        <a class="btn btn-outline-primary rounded-circle" href="{{ route('clients.edit', $client) }}">
                        ...
                        <form action="{{ route('clients.destroy', $client) }}" method="POST">
                            ...
                            <button class="btn btn-outline-danger rounded-circle"
                                onclick="return confirm('Tem certeza que deseja deletar este item?')" type="submit">
